...
<body>
    ...
    <header>
        <div class="site-logo">
            <img src="./images/instalogo.png" onclick=location.href="./">
        </div>
        ...
        <div class="header-icons">
            ...
            <img src="./images/oskar-yildiz-cOkpTiJMGzA-unsplash.jpg" class="profile-button" onclick=location.href="profile">
        </div>
    </header>
        ...
        <div class="posts-div">
            ...
            <div class="stories-board">
                <div class="story-card">
                    ...
                    <p class="story-username">aniketsa0101</p>
                </div>
            ...
            <div class="post">
                <div class="post-header">
                   ...
                   <div class="post-info">
                       <p class="post-username bold-font">aniketsa0101</p>
                ...
                <div class="post-footer">
                 ...
                 <div class="post-caption">
                     <b class="bold-font">aniketsa0101</b> My First Cool Post
                 </div>
        ...
        <div class="right-sidebar">
            <div class="profile">
                <div class="profile-pic">
                    <img src="./images/7-2-python-logo-free-download-png.png">
                </div>

                <div class="user-info">
                    <p class="username bold-font"><b>aniketsa0101</b></p>
                    <p class="username">Aniket Salunke</p>
                </div>
            </div>
